      ...
      *------------------------
       77  SOURCE-NAME PIC X(12) VALUE 'BYETHNIC.XML'.
      ...
      *    01  REPORT-STATUS.
       ...
       01  STATE-MACHINE PIC X(6) VALUE ' '.
           ...
           88 STATE-LATIN    VALUE 'latin'.
           88 STATE-NOTLATIN VALUE 'notlat'.

       01  DATA-RECORD.
           05 REC-RECORD-ID  PIC X(8)        VALUE ALL SPACES.
           05 REC-DATE       PIC X(10)       VALUE ALL SPACES.
           05 REC-INA        PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-LATIN      PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-NOTLATIN   PIC 9(7) COMP-4 VALUE ZERO.
      ...
      ******************************************************************
      ...
      D          DISPLAY '<' XML-text '>'
                 EVALUATE TRUE ALSO XML-text
                    ...
                    WHEN STATE-ROW ALSO "hispanic_or_latino"
                       SET STATE-LATIN TO TRUE
                    WHEN STATE-ROW ALSO "not_hispanic_or_latino"
                       SET STATE-NOTLATIN TO TRUE
                    WHEN OTHER
                       CONTINUE
                 END-EVALUATE
      ...
      D                   REC-LATIN REC-NOTLATIN
                       *> Save the record
                       PERFORM 6000-SAVE-REC
                    WHEN STATE-REC-ID   ALSO "record_id"
                    WHEN STATE-DATE     ALSO "date"
                    WHEN STATE-INA      ALSO "ina"
                    WHEN STATE-LATIN    ALSO "hispanic_or_latino"
                    WHEN STATE-NOTLATIN ALSO "not_hispanic_or_latino"
                       SET STATE-ROW TO TRUE
                    WHEN OTHER
                       CONTINUE
                 END-EVALUATE
      ...
      D          DISPLAY STATE-MACHINE
                 EVALUATE TRUE
                    ...
                    WHEN STATE-LATIN
                       MOVE XML-text TO REC-LATIN
                    WHEN STATE-NOTLATIN
                       MOVE XML-text TO REC-NOTLATIN
                    WHEN OTHER
                       CONTINUE
                 END-EVALUATE
              WHEN OTHER
      ...
      ******************************************************************
       6050-MOVE-DATA-TO-BUFFER.
           ...
           MOVE REC-LATIN     TO FD-HISPANIC-OR-LATINO
           MOVE REC-NOTLATIN  TO FD-NOT-HISPANIC-OR-LATINO
           .
