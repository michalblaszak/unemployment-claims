      ...
      *    IN-STATUS from FILESTS copybook
           SELECT IN-DATASET ASSIGN TO BYAGEDD
      ...
      *------------------------
       77  SOURCE-NAME PIC X(12) VALUE 'BYAGE.XML'.
      ...
      *    01  REPORT-STATUS.
       ...
       01  STATE-MACHINE PIC X(6) VALUE ' '.
           ...
           88 STATE-LESS-22  VALUE '_22'.
           88 STATE-22-24    VALUE '_22_24'.
           88 STATE-25-34    VALUE '_25_34'.
           88 STATE-35-44    VALUE '_35_44'.
           88 STATE-45-54    VALUE '_45_54'.
           88 STATE-55-59    VALUE '_55_59'.
           88 STATE-60-64    VALUE '_60_64'.
           88 STATE-MORE-64  VALUE '_65'.

       01  DATA-RECORD.
           05 REC-RECORD-ID  PIC X(8)        VALUE ALL SPACES.
           05 REC-DATE       PIC X(10)       VALUE ALL SPACES.
           05 REC-INA        PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-LESS-22    PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-22-24      PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-25-34      PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-35-44      PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-45-54      PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-55-59      PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-60-64      PIC 9(7) COMP-4 VALUE ZERO.
           05 REC-MORE-64    PIC 9(7) COMP-4 VALUE ZERO.
      ...
      ******************************************************************
      ...
      D          DISPLAY '<' XML-text '>'
                 EVALUATE TRUE ALSO XML-text
                    ...
                    WHEN STATE-ROW ALSO "_22"
                       SET STATE-LESS-22 TO TRUE
                    WHEN STATE-ROW ALSO "_22_24"
                       SET STATE-22-24 TO TRUE
                    WHEN STATE-ROW ALSO "_25_34"
                       SET STATE-25-34 TO TRUE
                    WHEN STATE-ROW ALSO "_35_44"
                       SET STATE-35-44 TO TRUE
                    WHEN STATE-ROW ALSO "_45_54"
                       SET STATE-45-54 TO TRUE
                    WHEN STATE-ROW ALSO "_55_59"
                       SET STATE-55-59 TO TRUE
                    WHEN STATE-ROW ALSO "_60_64"
                       SET STATE-60-64 TO TRUE
                    WHEN STATE-ROW ALSO "_65"
                       SET STATE-MORE-64 TO TRUE
                    WHEN OTHER
                       CONTINUE
                 END-EVALUATE
      ...
      D                   REC-LESS-22 REC-22-24 REC-25-34
      D                   REC-35-44 REC-45-54 REC-55-59
      D                   REC-60-64 REC-MORE-64
                       *> Save the record
                       PERFORM 6000-SAVE-REC
                    WHEN STATE-REC-ID    ALSO "record_id"
                    WHEN STATE-DATE      ALSO "date"
                    WHEN STATE-INA       ALSO "ina"
                    WHEN STATE-LESS-22   ALSO "_22"
                    WHEN STATE-22-24     ALSO "_22_24"
                    WHEN STATE-25-34     ALSO "_25_34"
                    WHEN STATE-35-44     ALSO "_35_44"
                    WHEN STATE-45-54     ALSO "_45_54"
                    WHEN STATE-55-59     ALSO "_55_59"
                    WHEN STATE-60-64     ALSO "_60_64"
                    WHEN STATE-MORE-64   ALSO "_65"
                       SET STATE-ROW TO TRUE
                    WHEN OTHER
                       CONTINUE
                 END-EVALUATE
      ...
      D          DISPLAY STATE-MACHINE
                 EVALUATE TRUE
                    ...
                    WHEN STATE-LESS-22
                       MOVE XML-text TO REC-LESS-22
                    WHEN STATE-22-24
                       MOVE XML-text TO REC-22-24
                    WHEN STATE-25-34
                       MOVE XML-text TO REC-25-34
                    WHEN STATE-35-44
                       MOVE XML-text TO REC-35-44
                    WHEN STATE-45-54
                       MOVE XML-text TO REC-45-54
                    WHEN STATE-55-59
                       MOVE XML-text TO REC-55-59
                    WHEN STATE-60-64
                       MOVE XML-text TO REC-60-64
                    WHEN STATE-MORE-64
                       MOVE XML-text TO REC-MORE-64
                    WHEN OTHER
                       CONTINUE
                 END-EVALUATE
              WHEN OTHER
      ...
      ******************************************************************
       6050-MOVE-DATA-TO-BUFFER.
           ...
           MOVE REC-INA       TO FD-INA-AGE
           MOVE REC-LESS-22   TO FD-LESS-22
           MOVE REC-22-24     TO FD-22-24
           MOVE REC-25-34     TO FD-25-34
           MOVE REC-35-44     TO FD-35-44
           MOVE REC-45-54     TO FD-45-54
           MOVE REC-55-59     TO FD-55-59
           MOVE REC-60-64     TO FD-60-64
           MOVE REC-MORE-64   TO FD-MORE-64
           .

       6050-MOVE-DATA-TO-BUFFER-END.
           EXIT.

       END PROGRAM IMPBYAGE.
